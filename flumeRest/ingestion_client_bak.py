...
@click.option('-p', '--port', default=8000, required=True, help='Port of data center')
...
@click.option('--lines', default=1, type=click.IntRange(1, 10), help='Lines of upload data per time')
@click.option('-v', '--version', default='v1', help='RestAPI version Default:[v1]')
